...
class buscaModels{
	...
	public function buscaDetallePropiedad($propiedad, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("SELECT P.id, P.titulo, P.status, P.precio, P.categoria, P.areaTerreno, P.areaConstruccion, P.habitaciones, P.banos, P.direccion, P.ciudad, P.estado, P.latitud, P.longitud, P.fotos, P.detalles, P.caracteristicas, P.vendedor, P.fechaRegistro, U.id as idAgente, U.nombre, U.telefono, U.email, U.password, U.personal, U.titulo as puesto, U.perfil, U.foto, U.estado as activo, U.ultimoLogin, U.fechaNac, U.sociales  FROM $tabla as P, usuarios as U WHERE P.id=$propiedad AND U.id = P.vendedor");
