...
/*=============================================
	...
	static public function mdlIngresarPropiedad($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (destacada, titulo, status, precio, categoria, areaTerreno, areaConstruccion, habitaciones, banos, direccion, ciudad, estado, CP, latitud, longitud, fotoPrincipal, detalles, condVenta, caracteristicas, vendedor) VALUES (:destacada, :nombre, :status, :precio, :categoria, :mtsTerreno, :mtsConstruccion, :habitaciones, :banos, :direccion, :ciudad, :estado, :CP, :latitud, :longitud, :foto, :detalles, :condiciones, :caract, :agenteID)");
	...
	static public function mdlActualizarPropiedad($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET destacada=:destacada, titulo=:nombre, status=:status, precio=:precio, categoria=:categoria, areaTerreno=:mtsTerreno, areaConstruccion=:mtsConstruccion, habitaciones=:habitaciones, banos=:banos, direccion=:direccion, ciudad=:ciudad, estado=:estado, CP=:CP, latitud = :latitud, longitud = :longitud, fotoPrincipal=:fotoPrincipal, detalles=:detalles, condVenta=:condiciones, caracteristicas=:caract, vendedor=:agenteID WHERE id = :id");
